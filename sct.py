...
logo =                                          """            
\033[1;37m   _____    _____   _______ 
\033[1;37m   / ____|   / ____| |__   __|
\033[1;37m   | (___   |  |                     | |   
\033[1;37m    \___ \  |  |                    | |   
\033[1;37m    ____) |  | |____         | |     
\033[1;37m  |_____/   \_____|    |_| 
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Ranjit Sannashi 
\033[1;37m Facebook:            RANJITTH SANNASHI 
\033[1;37m Github  :            FYCK YOU 
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back SCT Menu ")
        exit()
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://facebook.com/groups/we.are.hindu.111/')
        pass
    elif select =='F':
        os.system('xdg-open https://facebook.com/groups/we.are.hindu.111/')
    else:
...
def cutter():
    ...
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +sct)
    os.system('sort -r '+sct+' | uniq > '+sct)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + Sct)
    print("New File Saved:" + sct )
    print(47*'-')
    input(f"{S} Press Enter To Back Sct Menu ")
    SSB(allkey)       
